...
public class SpitfireAI : MonoBehaviour
{
    ...
    void FireAtHeinkel()
    {
        ...
        if (isFiring == true)
        {
            if (timer <= 1.0f)
            {
                ...
                if (hitChance == 1)
                {
                    heinkelTarget.GetHitBySpitfire();
    ...
    void FireAtJunkers()
    {
        ...
        if (isFiring == true)
        {
            if (timer <= 1.0f)
            {
                ...
                if (hitChance == 1)
                {
                    junkersTarget.GetHitBySpitfire();
    ...
    void FireAtDornier()
    {
        ...
        if (isFiring == true)
        {
            if (timer <= 1.0f)
            {
                ...
                if (hitChance == 1)
                {
                    dornierTarget.GetHitBySpitfire();
    ...
    public void GetDestroyed()
    {
        ...
        if (safeLand == false)
        {
            Debug.Log("Spitfire shot down");
        }
        if (safeLand == true)
        {
            Debug.Log("Spitfire landed");
        }
    ...
    void Land()
    {
        ...
        airbaseScript.AddSpitfire(); // readd Spitfire
        safeLand = true;
        ScoreScreen score = GameObject.Find("ScoreScreen").GetComponent<ScoreScreen>();
        score.addBritishFighter(-1);
        GetDestroyed();
