...
public class Heinkel : GermanBomber
{
    ...
    void FireAtSpitfire()
    {
        ...
        if (isFiring == true)
        {
            if (timer <= 1.0f)
            {
                ...
                if (hitChance == 1)
                {
                    spitfireTarget.GetHitByHeinkel();
                    spitfireTarget.RemoveFromChaserList(transform.root.gameObject);
                    fireTarget = transform.root.gameObject;
                }
            }
    ...
    void FireAtHurricane()
    {
        ...
        if (isFiring == true)
        {
            if (timer <= 1.0f)
            {
                ...
                if (hitChance == 1)
                {
                    hurricaneTarget.GetHitByHeinkel();
                    hurricaneTarget.RemoveFromChaserList(transform.root.gameObject);
                    fireTarget = transform.root.gameObject;
                }
            }
    ...
    public void GetDestroyed()
    {
        ...
        {
            Debug.Log("Heinkel shot down");
        }
        if (missionComplete == true)
        {
            Debug.Log("Heinkel Landed");
        }
