...
public class BF110AI : MonoBehaviour
{
    ...
    public void GetHitBySpitfire()
    {
        ...
        int pilotHitChance = Random.Range(1, 12); // chance to hit pilot
        if (pilotHitChance == 1)
        {
            pilot = 1;
            accuracy = accuracy - 1;
        ...
        int engineHitChance = Random.Range(1, 3); // chance to hit engine
    ...
    public void GetHitByHurricane()
    {
        ...
        int pilotHitChance = Random.Range(1, 10); // chance to hit pilot
        if (pilotHitChance == 1)
        {
            pilot = 1;
            accuracy = accuracy - 1;
    ...
    public void GetDestroyed()
    {
        if (safeLand == false)
        {
            Debug.Log("BF110 shot down");
        }
        if (safeLand == true)
        {
            Debug.Log("BF110 landed");
        }
    ...
    void Land()
    {
        ...
        airbaseScript.AddBf110(); // readd BF109
        safeLand = true;
        ScoreScreen score = GameObject.Find("ScoreScreen").GetComponent<ScoreScreen>();
        score.addGermanFighter(-1);
        GetDestroyed();
